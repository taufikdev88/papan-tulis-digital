...
public class SavedArt implements Serializable {
    ...
    private static com.example.papantulisdigital.model.SavedArt mModel = null;
    ...
    public static com.example.papantulisdigital.model.SavedArt getInstance(Context context)
    {
        if (mModel == null)
            mModel = new com.example.papantulisdigital.model.SavedArt(context);
